...
func TerraformOutputsDataSourceSchema(ctx context.Context) schema.Schema {
	return schema.Schema{
		Description:         "This datasource allows you to fetch existing terraform outputs from the Cycloid inventory. Look up the documentation on outputs: https://docs.cycloid.io/reference/projects/concepts/components#outputs-from-terraform-outputs",
		MarkdownDescription: "This datasource allows you to fetch existing terraform outputs from the Cycloid inventory. Look up the [documentation on outputs](https://docs.cycloid.io/reference/projects/concepts/components#outputs-from-terraform-outputs).",
		Attributes: map[string]schema.Attribute{
			"filters": schema.ListNestedAttribute{
				...
				Optional:            true,
				Description:         "List of LHS filters to apply to the outputs. See the docs here: https://docs.cycloid.io/reference/api/LHS-filters",
				MarkdownDescription: "List of LHS filters to apply to the outputs. See the docs [here](https://docs.cycloid.io/reference/api/LHS-filters)",
			},
			...
			"outputs": schema.DynamicAttribute{
				Computed:            true,
				Sensitive:           true,
				Description:         `A list of terraform outputs, the output schema will match the result of a listInventoryOutputs API call in the console: https://docs.cycloid.io/api/#tag/Organization-Inventory/operation/listInventoryOutputs. The 'value' and 'type' attributes in the terraform outputs will be dynamic depending on the terraform output itself.`,
				MarkdownDescription: `A list of terraform outputs, the output schema will match the result of a [listInventoryOutputs API call in the console](https://docs.cycloid.io/api/#tag/Organization-Inventory/operation/listInventoryOutputs). The 'value' and 'type' attributes in the terraform outputs will be dynamic depending on the terraform output itself.`,
			},
		},
	}
}
