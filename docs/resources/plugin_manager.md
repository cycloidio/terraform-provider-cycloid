...
executes installed plugins inside the organization. Registering it sends an invite to the manager
service; Cycloid automatically accepts it in the same apply step.
