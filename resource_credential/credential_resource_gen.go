	...
	return schema.Schema{
		...
		Attributes: map[string]schema.Attribute{
			"body": schema.SingleNestedAttribute{
				Attributes: map[string]schema.Attribute{
					"access_key": schema.StringAttribute{
						Optional:            true,
						Computed:            true,
						Description:         "An AWS access key or Azure Storage Access key, required for type `aws` or `azure_storage`.",
						MarkdownDescription: "An AWS access key or Azure Storage Access key, required for type `aws` or `azure_storage`.",
					},
					"account_name": schema.StringAttribute{
						Optional:            true,
						Computed:            true,
						Description:         "Account name required for `azure_storage`.",
						MarkdownDescription: "Account name required for `azure_storage`.",
					},
					"auth_url": schema.StringAttribute{
						Optional:            true,
						Computed:            true,
						Description:         "Required for type `swift`.",
						MarkdownDescription: "Required for type `swift`.",
					},
					"ca_cert": schema.StringAttribute{
						Optional:            true,
						Computed:            true,
						Description:         "For type `elasticsearch`, you must fill either:\n  - `ca_cert`\n  - `username` + `password`\n  - `username` + `password` + `cacert`.",
						MarkdownDescription: "For type `elasticsearch`, you must fill either:\n  - `ca_cert`\n  - `username` + `password`\n  - `username` + `password` + `cacert`.",
					},
					"client_id": schema.StringAttribute{
						Optional:            true,
						Computed:            true,
						Description:         "Required for type `azure`.",
						MarkdownDescription: "Required for type `azure`.",
					},
					...
					"json_key": schema.StringAttribute{
						Optional:            true,
						Computed:            true,
						Description:         "Required for type `gcp`.",
						MarkdownDescription: "Required for type `gcp`.",
					},
					"password": schema.StringAttribute{
						Optional:            true,
						Computed:            true,
						Description:         "Required for type `basic_auth`, `swift`, `vmware` or `elasticsearch`.",
						MarkdownDescription: "Required for type `basic_auth`, `swift`, `vmware` or `elasticsearch`.",
					},
					"raw": schema.MapAttribute{
						ElementType:         types.StringType,
						Optional:            true,
						Computed:            true,
						Description:         "Credential fields required for type `custom`.",
						MarkdownDescription: "Credential fields required for type `custom`.",
					},
					"secret_key": schema.StringAttribute{
						Optional:            true,
						Computed:            true,
						Description:         "An AWS secret key, required for type AWS.",
						MarkdownDescription: "An AWS secret key, required for type AWS.",
					},
					"ssh_key": schema.StringAttribute{
						Optional:            true,
						Computed:            true,
						Description:         "Required for type `ssh`.",
						MarkdownDescription: "Required for type `ssh`.",
					},
				...
				Computed:            true,
				Sensitive:           true,
				Description:         "The credential values, use the fields related to the credential `type`.",
				MarkdownDescription: "The credential values, use the fields related to the credential `type`.",
			},
			...
			"description": schema.StringAttribute{
				...
				MarkdownDescription: "The description of the credential.",
			},
			"name": schema.StringAttribute{
				Required:            true,
				Description:         "The name displayed in the UI of the credential.",
				MarkdownDescription: "The name displayed in the UI of the credential.",
			},
			...
			"path": schema.StringAttribute{
				Required:            true,
				Description:         "The credential path written in vault and use for `pipelines`.",
				MarkdownDescription: "The credential path written in vault and use for `pipelines`.",
				Validators: []validator.String{
			...
			"type": schema.StringAttribute{
				Required:            true,
				Description:         "The type of the credential, see [the docs](https://docs.cycloid.io/reference/credentials/concepts).",
				MarkdownDescription: "The type of the credential, see [the docs](https://docs.cycloid.io/reference/credentials/concepts).",
				Validators: []validator.String{
					stringvalidator.OneOf(
						"ssh",
						"aws",
