...
func (p *CycloidProvider) Configure(ctx context.Context, req provider.ConfigureRequest, resp *provider.ConfigureResponse) {
	...
	p.Client = apiclient.NewAPIClient(p.APIClient)
