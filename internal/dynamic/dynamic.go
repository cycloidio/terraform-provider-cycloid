...
func AnyToAttributeTypeAndValue(ctx context.Context, data any) (attr.Type, attr.Value, diag.Diagnostics) {
	...
	default:
		diags.AddError("Unsupported type "+v.Kind().String()+" for value conversion to dynamic value.", "This is an error from the provider, please reach out to the developer")
